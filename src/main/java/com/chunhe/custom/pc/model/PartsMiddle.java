...
@Setter
//@EqualsAndHashCode
public class PartsMiddle extends BaseEntity{
    /**
     * 钻石类型 1、现货，2、全球
     */
    ...
    public PartsMiddle(String code, String name, Integer type, String exYy, String exQghy, String exJscz,
    ...
    public PartsMiddle newParts() {
        PartsMiddle p1 = new PartsMiddle();
        return p1;
    }
