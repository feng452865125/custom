...
(function(){
	...
	var Chart = function(context){
		...
		//High pixel density displays - multiply the size of the canvas height/width by the deviceCabinet pixel ratio, then scale.
	...
	Chart.RadialScale = Chart.Element.extend({
		...
		setScaleSize: function(){
			 ...
			 *
			 * We average the left and right distances to get the maximum shape radius that can fit in the series
			 * along with labels.
			 *
