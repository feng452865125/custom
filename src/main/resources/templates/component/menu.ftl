...
[@authorize ifAnyGranted="permission:page,user:page,role:page"]
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            [@authorize ifAnyGranted="user:page"]
                <li><a href="${springMacroRequestContext.contextPath}/user/list"><i class="fa fa-circle"></i> 店铺</a>
                </li>
            [/@authorize]
            [@authorize ifAnyGranted="role:page"]
                <li><a href="${springMacroRequestContext.contextPath}/role/list"><i class="fa fa-circle"></i> 角色</a>
                </li>
            [/@authorize]
            [@authorize ifAnyGranted="permission:page"]
                <li><a href="${springMacroRequestContext.contextPath}/permission/list"><i class="fa fa-circle"></i>
                    权限</a>
                </li>
            [/@authorize]
        </ul>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            [@authorize ifAnyGranted="advertisement:page"]
                <li><a href="${springMacroRequestContext.contextPath}/advertisement/list"><i class="fa fa-circle"></i>
                    广告栏维护</a>
                </li>
            [/@authorize]
            [@authorize ifAnyGranted="flowerHead:page"]
                <li><a href="${springMacroRequestContext.contextPath}/flowerHead/list"><i class="fa fa-circle"></i> 花头维护</a>
                </li>
            [/@authorize]
            ...
            [/@authorize]
             [@authorize ifAnyGranted="groupInfo:page"]
                <li><a href="${springMacroRequestContext.contextPath}/groupInfo/list"><i class="fa fa-circle"></i> 组信息维护</a>
                </li>
             [/@authorize]
            ...
            [@authorize ifAnyGranted="additionalCosts:page"]
                <li><a href="${springMacroRequestContext.contextPath}/additionalCosts/list"><i class="fa fa-circle"></i>
                    附加费用维护</a>
                </li>
            [/@authorize]
            ...
            [@authorize ifAnyGranted="dataSynch:page"]
                <li><a href="${springMacroRequestContext.contextPath}/dataSynch/list"><i class="fa fa-circle"></i> 数据同步</a>
                </li>
            [/@authorize]
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            [@authorize ifAnyGranted="dadaJewelryType:page"]
                <li><a href="${springMacroRequestContext.contextPath}/dadaJewelryType/list"><i class="fa fa-circle"></i>
                    类别维护</a>
                </li>
            [/@authorize]
            [@authorize ifAnyGranted="dadaSeries:page"]
                <li><a href="${springMacroRequestContext.contextPath}/dadaSeries/list"><i class="fa fa-circle"></i> 系列维护</a>
                </li>
            [/@authorize]
                [@authorize ifAnyGranted="dadaStyle:page"]
                <li><a href="${springMacroRequestContext.contextPath}/dadaStyle/list"><i class="fa fa-circle"></i> 样式维护</a>
                </li>
                [/@authorize]
        </ul>
    </li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            [@authorize ifAnyGranted="priceInquiry:page"]
                <li><a href="${springMacroRequestContext.contextPath}/priceInquiry/list"><i class="fa fa-circle"></i>
                    价格查询</a>
                </li>
            [/@authorize]
             [@authorize ifAnyGranted="certificateInquiry:page"]
                <li><a href="${springMacroRequestContext.contextPath}/certificateInquiry/list"><i class="fa fa-circle"></i>
                    证书查询</a>
                </li>
             [/@authorize]
        </ul>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            [@authorize ifAnyGranted="customCardTask:page"]
                <li><a href="${springMacroRequestContext.contextPath}/customCardTask/list"><i class="fa fa-circle"></i>
                    制卡任务维护</a>
                </li>
            [/@authorize]
...
[@authorize ifAnyGranted="thirdSupplier:page"]
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            [@authorize ifAnyGranted="thirdSupplier:page"]
                <li><a href="${springMacroRequestContext.contextPath}/thirdSupplier/list"><i class="fa fa-circle"></i>
                    钻石供应商维护</a>
                </li>
            [/@authorize]
        </ul>
