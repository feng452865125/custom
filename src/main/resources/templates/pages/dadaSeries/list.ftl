    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                [/@searchable]
                <div>
                    [@authorize ifAnyGranted="dadaSeries:add"]
                        <a class="btn btn-flat bg-olive" href="${springMacroRequestContext.contextPath}/dadaSeries/add"
                           redirect>新增</a>
                    [/@authorize]
                </div>
    ...
    $(function () {
        ...
        var dataTable = $form.DataTable({
            ...
            'columns': [
                ...
                {data: 'createDate', name: 'createDate'},
                {
                    data: 'id', orderable: false, render: function (data, type, full, meta) {
                        var operations = [];
                    [@authorize ifAnyGranted="dadaSeries:view"]
                        operations.push('<a redirect href="${springMacroRequestContext.contextPath}/dadaSeries/view/' + data + '">详情</a>');
                    [/@authorize]
                    [@authorize ifAnyGranted="dadaSeries:edit"]
                        operations.push('<a redirect href="${springMacroRequestContext.contextPath}/dadaSeries/edit/' + data + '">编辑</a>');
                    [/@authorize]
                    [@authorize ifAnyGranted="dadaSeries:delete"]
            ...
            'ajax': {
                ...
                'url': '${springMacroRequestContext.contextPath}/dadaSeries/pagination',
                'type': 'POST',
        ...
        $form.on('click', '.btn-delete', function () {
            var $this = $(this);
            var id = $this.data('id');
            var url = "${springMacroRequestContext.contextPath}/dadaSeries/" + id;
        ...
        dataTable.on('draw.dt', function () {
            ...
            var confirmOperation = function () {
                ...
                $.ajax({
                    url: "${springMacroRequestContext.contextPath}/dadaSeries/" + id + "/" + extUrl,
                    type: 'PATCH',
