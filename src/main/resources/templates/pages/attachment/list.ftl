    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                [/@searchable]
                <div>
                    [@authorize ifAnyGranted="attachment:add"]
                        <a class="btn btn-flat bg-olive" href="${springMacroRequestContext.contextPath}/attachment/add"
                           redirect>新增</a>
                    [/@authorize]
                </div>
    ...
    $(function () {
        ...
        var dataTable = $form.DataTable({
            ...
            'columns': [
                ...
                {data: 'createDate', name: 'createDate'},
                {
                    data: 'id', orderable: false, render: function (data, type, full, meta) {
                        var operations = [];
                    [@authorize ifAnyGranted="attachment:view"]
                        operations.push('<a redirect href="${springMacroRequestContext.contextPath}/attachment/view/' + data + '">详情</a>');
                    [/@authorize]
                    [@authorize ifAnyGranted="attachment:edit"]
                        operations.push('<a redirect href="${springMacroRequestContext.contextPath}/attachment/edit/' + data + '">编辑</a>');
                    [/@authorize]
                    [@authorize ifAnyGranted="attachment:delete"]
            ...
            'ajax': {
                ...
                'url': '${springMacroRequestContext.contextPath}/attachment/pagination',
                'type': 'POST',
        ...
        $form.on('click', '.btn-delete', function () {
            var $this = $(this);
            var id = $this.data('id');
            var url = "${springMacroRequestContext.contextPath}/attachment/" + id;
        ...
        dataTable.on('draw.dt', function () {
            ...
            var confirmOperation = function () {
                ...
                $.ajax({
                    url: "${springMacroRequestContext.contextPath}/attachment/" + id + "/" + extUrl,
                    type: 'PATCH',
