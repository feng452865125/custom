...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- /.series-header -->
            <!-- form start -->
            <form id="form1" action="${springMacroRequestContext.contextPath}/advertisement" role="form">
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            <div class="form-group">
                                <label for="name">名称</label>
                                <input class="form-control" name="name" id="name" placeholder="请输入图片名称"
                                       data-rule="required"
                                       data-msg-required="图片名称不能为空"
                                >
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-xs-5 col-md-4">
                            <div class="form-group">
                                <label for="url">图片（推荐尺寸：2048*600）</label>
                                <input type="hidden" name="url" class="relFile">
                                <span class="btn btn-success fileinput-button">
                                    <i class="fa fa-plus"></i>
                                    <span>添加</span>
                                    <input class="fileupload" type="file" name="file" data-url="/api/upload?dir=advertisement">
                                </span>
