...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- /.series-header -->
            <!-- form start -->
            <form id="form1" action="${springMacroRequestContext.contextPath}/printing" role="form">
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control remark_style" id="remark" name="remark" placeholder="印花描述"></textarea>
                            </div>
                        </div>
                        <div class="col-xs-5 col-md-4">
                            <div class="form-group">
                                <label for="url">图片（推荐尺寸：800*600）</label>
                                <input type="hidden" name="url" class="relFile">
                                <span class="btn btn-success fileinput-button">
                                    <i class="fa fa-plus"></i>
                                    <span>添加</span>
                                    <input class="fileupload" type="file" name="file" data-url="/api/upload?dir=printing">
                                </span>
