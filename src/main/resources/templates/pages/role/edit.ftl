...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- /.series-header -->
            <!-- form start -->
            <form id="form1" action="${springMacroRequestContext.contextPath}/role/${role.id}" role="form">
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="请输入名称"
                                    value="${role.name!""}"
                                    data-rule="required;length(1~32);remote(get:${springMacroRequestContext.contextPath}/role/nameCheck, id=${role.id})"
                            ...
                            <div class="form-group">
                                ...
                                <div class="icheck-group">
                                    <div class="icheck-item">
                                        <input type="radio" id="system" class="minimal" name="isSystem" value=true data-rule="checked" 
                                            [#if role.isSystem]
                                                checked
                                            [/#if]
                                        >
                    ...
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-10 col-md-8">
                            <div class="form-group">
                                ...
                                <div>
                                    [#if permissionsMap??]
                                        [#list permissionsMap?keys as key ]
                                            <div class="icheck-group">
    ...
    $(function() {
        ...
        var initCheckboxs = function() {
            $checkGroup.each(function(index, item) {
                ...
                setChecked($this, isGroupCheck($checks));
            })
