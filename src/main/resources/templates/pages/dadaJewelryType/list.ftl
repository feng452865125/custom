            ...
            <div class="box-body">
                ...
                <div>
                    [@authorize ifAnyGranted="jewelryType:add"]
                        <a class="btn btn-flat bg-olive" href="${springMacroRequestContext.contextPath}/dadaJewelryType/add"
                           redirect>新增</a>
                    [/@authorize]
                </div>
    ...
    $(function () {
        ...
        var dataTable = $form.DataTable({
            ...
            'columns': [
                ...
                {data: 'createDate', name: 'createDate'},
                {
                    data: 'id', orderable: false, render: function (data, type, full, meta) {
                        var operations = [];
                    [@authorize ifAnyGranted="dadaJewelryType:view"]
                        operations.push('<a redirect href="${springMacroRequestContext.contextPath}/dadaJewelryType/view/' + data + '">详情</a>');
                    [/@authorize]
                    [@authorize ifAnyGranted="dadaJewelryType:edit"]
                        operations.push('<a redirect href="${springMacroRequestContext.contextPath}/dadaJewelryType/edit/' + data + '">编辑</a>');
                    [/@authorize]
                    [#--[@authorize ifAnyGranted="dadaJewelryType:delete"]--]
            ...
            'ajax': {
                ...
                'url': '${springMacroRequestContext.contextPath}/dadaJewelryType/pagination',
                'type': 'POST',
        ...
        $form.on('click', '.btn-delete', function () {
            var $this = $(this);
            var id = $this.data('id');
            var url = "${springMacroRequestContext.contextPath}/dadaJewelryType/" + id;
