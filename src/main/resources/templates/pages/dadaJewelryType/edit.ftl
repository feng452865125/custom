...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- /.series-header -->
            <!-- form start -->
            <form id="form1" action="${springMacroRequestContext.contextPath}/dadaJewelryType/${dadaJewelryType.id}" role="form">
                <div class="box-body">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            <div class="form-group">
                                ...
                                <textarea class="form-control remark_style" id="remark" name="remark" placeholder="类别描述">${dadaJewelryType.remark}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
