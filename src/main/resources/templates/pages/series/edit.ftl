...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- /.series-header -->
            <!-- form start -->
            <form id="form1" action="${springMacroRequestContext.contextPath}/series/${series.id}" role="form">
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-xs-5 col-md-1">
                            <div class="form-group">
                                ...
                                <i class="fa fa-check bc_upload_tip tip_success"
                                    [#if series.imgUrl?? && series.imgUrl?length > 0]
                                        style="display: block"
                                    [/#if]
                                ></i>
                        ...
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            <div class="form-group">
                                ...
                                <textarea class="form-control remark_style" id="remark" name="remark"
                                          placeholder="文件描述">${series.remark}</textarea>
                            </div>
                        </div>
                        <div class="col-xs-5 col-md-4">
                            <div class="from-group">
                                ...
                                <div style="height: 108px;">
                                    [#if series.imgUrl?? && series.imgUrl?length > 0]
                                        <img src="${series.imgUrl}" class="img_shadow seriesImg"
                                             style="height: 100%;">
                                    [#else]
                                        <img src="${series.imgUrl}" class="seriesImg">
                                    [/#if]
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-offset-1 col-xs-5 col-md-7">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="introductionVideo" id="introductionVideo"
                                       value="${series.introductionVideo}">
                                <label class="bc_upload">上传
...
<script>
    $(function () {
        ...
        $form.on('valid.form', function (e, form) {
            ...
            $.ajax({
                url: "${springMacroRequestContext.contextPath}/series/${series.id}",
    ...
    function changePic(target, id) {
        ...
        $.ajax({
            url: "${springMacroRequestContext.contextPath}/api/upload?dir=seriesIntroduction",
            type: "POST",
            data: formData,
