...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- /.series-header -->
            <!-- form start -->
            <form id="form1" action="${springMacroRequestContext.contextPath}/diamondKela" role="form">
                <div class="box-body">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="name" id="name" placeholder="请输入名称" value="裸石">
                            </div>
                        </div>
                        <div class="col-xs-5 col-md-4">
                            <div class="form-group">
                                <label for="exZsZl">质量（单位：千克）</label>
                                <input class="form-control" name="exZsZl" id="exZsZl" placeholder="请输入质量"
                                       data-rule="required"
                    ...
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="exZsXz" id="exZsXz" placeholder="请输入形状" value="圆形">
                            </div>
                        </div>
                        <div class="col-xs-5 col-md-4">
                            <div class="form-group">
                                <label for="exZsZs">证书</label>
                                <input class="form-control" name="exZsZs" id="exZsZs" placeholder="请输入证书" value="GIA">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="exZsYs" id="exZsYs" placeholder="请输入颜色" value="D">
                            </div>
                        </div>
                        <div class="col-xs-5 col-md-4">
                            <div class="form-group">
                                <label for="exZsJd">净度（FL、IF、VVS1、VVS2、VS1、VS2、SI1、SI2）</label>
                                <input class="form-control" name="exZsJd" id="exZsJd" placeholder="请输入净度" value="FL">
                            </div>
                        </div>
                    </div>
                    <div class="row">
