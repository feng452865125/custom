            ...
            <form id="form1" action="${springMacroRequestContext.contextPath}/style/${style.id}" role="form">
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-8">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="remark" id="remark" value="${style.remark}"
                                       placeholder="图片描述">
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row imgsUrlList">
                                    ...
                                    <div class="col-xs-5 col-md-1">
                                        <div class="form-group">
                                            ...
                                            <i class="fa fa-check bc_upload_tip_top8 tip_success" style="display: block"></i>
                    ...
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-7">
                            <div class="form-group">
                                <label for="rate45imgUrl">45度文件</label>
                    ...
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-7">
                            <div class="form-group">
                                <label for="threeDUrl">3D文件</label>
                                <input class="form-control" name="threeDUrl" id="threeDUrl" value="${style.threeDUrl}">
                                <label class="bc_upload">上传
                                    <input type="file" style="display: none;" accept="image/png, image/jpeg, image/jpg"
                                           onchange="changePic(this, threeDUrl)"/>
                                </label>
                            </div>
                        </div>
                        <div class="col-xs-5 col-md-1">
