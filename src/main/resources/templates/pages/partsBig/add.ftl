...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- /.series-header -->
            <!-- form start -->
            <form id="form1" action="${springMacroRequestContext.contextPath}/partsBig" role="form">
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            <div class="form-group">
                                <label for="zsKh">款号（公司代码-序号，如：A-1）</label>
                                <input class="form-control" name="zsKh" id="zsKh" placeholder="请输入款号"
                                       data-rule="required"
                        ...
                        <div class="col-xs-5 col-md-2">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="zsZsh" id="zsZsh" placeholder="请输入GIA证书号"
                                       data-rule="required"
                        ...
                        <div class="col-xs-5 col-md-2">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="zsZl" id="zsZl" placeholder="请输入质量"
                                       data-rule="required"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="zsYg" name="zsYg" data-rule="noSelect">
                                    ...
                                    [#list zsYgList.keys as zsYg]
                                        <option value="${zsYg.label}">${zsYg.label}</option>
                                    [/#list]
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="zsKd" id="zsKd" placeholder="请输入扣点">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="zsGjbj" id="zsGjbj" placeholder="请输入国际报价">
                            </div>
                        </div>
                        <div class="col-xs-5 col-md-4">
                            <div class="form-group">
                                <label for="zsCtjj">基价报价</label>
                                <input class="form-control" type="number" name="zsCtjj" id="zsCtjj" placeholder="请输入基价报价">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="zsMj" id="zsMj" placeholder="请输入美金报价">
                            </div>
                        </div>
                        <div class="col-xs-5 col-md-4">
                            <div class="form-group">
                                <label for="zsRmb">人民币</label>
                                <input class="form-control" type="number" name="zsRmb" id="zsRmb" placeholder="请输入人民币报价">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="zsPrice" id="zsPrice" placeholder="请输入销售价"
                                       data-rule="required"
                                       data-msg-required="款号不能为空">
                            </div>
                        </div>
