...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- /.series-header -->
            <!-- form start -->
            <form id="form1" action="${springMacroRequestContext.contextPath}/permission/${permission.id}" role="form">
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="code" name="code" placeholder="请输入编码"
                                       ...
                                       data-rule="required;remote(get:${springMacroRequestContext.contextPath}/permission/codeCheck, id=${permission.id})"
                        ...
                        <div class="col-xs-5 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="请输入名称"
                                       ...
                                       data-rule="required;length(1~64)"
                                >
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="icheck-group">
                                    <div class="icheck-item">
                                        <input type="radio" class="minimal" id="system" name="isSystem" value=true data-rule="checked" [#if permission.isSystem] checked [/#if]>
                                        <label for="system">是</label>
                                    </div>
                                    <div class="icheck-item">
                                        <input type="radio" class="minimal" id="unsystem" name="isSystem" value=false data-rule="checked" [#if !permission.isSystem] checked [/#if]>
