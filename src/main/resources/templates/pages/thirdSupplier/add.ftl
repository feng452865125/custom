...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- /.series-header -->
            <!-- form start -->
            <form id="form1" action="${springMacroRequestContext.contextPath}/thirdSupplier" role="form">
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-xs-5 col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="shortName" id="shortName" placeholder="请输入英文简称"
                                       data-rule="required;remote(get:${springMacroRequestContext.contextPath}/thirdSupplier/check/shortName)"
                                       data-msg-required="英文简称不能为空"
                                       data-msg-remote="英文简称已存在"
                                >
                            </div>
                        </div>
                        <div class="col-xs-5 col-md-3">
                        ...
                        <div class="col-xs-offset-1 col-xs-5 col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="keerUsername" id="keerUsername"
                                       placeholder="请输入千叶登录账号"
                                       [#--data-rule="required;remote(get:${springMacroRequestContext.contextPath}/thirdSupplier/check/keerUsername)"--]
                                       [#--data-msg-required="千叶登录账号不能为空"--]
                                       [#--data-msg-remote="千叶登录账号已存在"--]
                                >
                            </div>
                        </div>
                        <div class="col-xs-5 col-md-3">
                        ...
                        <div class="col-xs-offset-1 col-xs-5 col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-daterange">
                                    <input class="form-control workDate" style="text-align: left;" name="workDate" placeholder="请选择开始合作时间">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-5 col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="sapCode" id="sapCode" placeholder="请输入sap供应商编码">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="filterAddress" id="filterAddress" placeholder="哪些库存地允许接收">
                            </div>
                        </div>
                        <div class="col-xs-5 col-md-3">
                            <div class="form-group">
                                <label for="whiteZsbhList">证书号过滤白名单（用/隔开，例:XXX001/XXXX002）</label>
                                <input class="form-control" name="whiteZsbhList" id="whiteZsbhList" placeholder="白名单跳过过滤规则，直接接收">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-3">
                            <div class="form-group">
                                <label for="locationInHk">库存地统一改为HK（用/隔开，例:香港/香港A/HONGKONG/H-K）</label>
                                <input class="form-control" name="locationInHk" id="locationInHk" placeholder="设置的库存地地名改为'HK'">
                            </div>
                        </div>
                        <div class="col-xs-5 col-md-3">
                            <div class="form-group">
                                <label for="locationInSz">库存地统一改为SZ（用/隔开，例:深圳/SZ(在库)）</label>
                                <input class="form-control" name="locationInSz" id="locationInSz" placeholder="设置的库存地地名改为'SZ'">
                            </div>
                        </div>
                    </div>
                    <div class="row">
