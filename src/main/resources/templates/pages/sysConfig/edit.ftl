...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- /.series-header -->
            <!-- form start -->
            <form id="form1" action="${springMacroRequestContext.contextPath}/sysConfig/${sysConfig.id}" role="form">
                <div class="box-body">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="key" id="key" disabled
                                       value="${sysConfig.key}"
                                >
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="value" id="value" placeholder="请输入值"
                                       value="${sysConfig.value}"
                                       data-rule="required"
                                       data-msg-required="值不能为空"
                                >
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-offset-1 col-xs-5 col-md-4">
                            <div class="form-group">
                                <label for="remark">详情描述</label>
                                <textarea class="form-control remark_style" id="remark" name="remark" placeholder="详情描述">${sysConfig.remark!""}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(function () {
        ...
        $.submitForm("#form1", ".btn-submit", "PUT", ["${_csrf.parameterName}", "${_csrf.token}"],
                function (data) {
                    $.redirect("${springMacroRequestContext.contextPath}/sysConfig/list", function () {
                    });
                }, function (err) {
