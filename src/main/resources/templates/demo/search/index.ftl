        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="input-group">
                    <span class="input-group-addon">搜索项1</span>
                    <input type="text" name="id" class="form-control" placeholder="Username">
                </div>
                <div class="input-group">
                    <span class="input-group-addon">搜索项2</span>
                    <input type="text" name="name" class="form-control" placeholder="Username">
                </div>
                [/@searchable]
                <div>
                    <button type="button" class="btn btn-flat bg-olive">新增</button>
                    <button type="button" class="btn btn-flat bg-olive">激活</button>
                    <button type="button" class="btn btn-flat bg-olive">取消</button>
                </div>
